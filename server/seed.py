...
with app.app_context():
    ...
    # Add employees
    e1 = Employee(name="Uri Lee", hire_date=datetime(2022, 5, 17))
    e2 = Employee(name="Tristan Tal", hire_date=datetime(2020, 1, 30))
    e3 = Employee(name="Sasha Hao", hire_date=datetime(2021, 12, 1))
    e4 = Employee(name="Taylor Jai", hire_date=datetime(2015, 1, 2))
